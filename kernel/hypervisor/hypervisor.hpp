...
enum vmcs_field {
	...
	GUEST_VMCS_PREEMPTION_TIMER_VALUE	= 0x0000482E,
...
// Control bits
//
constexpr uint32_t CPU_BASED_HLT_EXITING             = 1u << 7;
constexpr uint32_t CPU_BASED_ACTIVATE_SECONDARY      = 1u << 31;
constexpr uint32_t VM_EXIT_HOST_ADDR_SPACE_SIZE      = 1u << 9;
constexpr uint32_t VM_EXIT_SAVE_IA32_PAT             = 1u << 18;
constexpr uint32_t VM_EXIT_LOAD_IA32_PAT             = 1u << 19;
constexpr uint32_t VM_EXIT_SAVE_IA32_EFER            = 1u << 20;
constexpr uint32_t VM_EXIT_LOAD_IA32_EFER            = 1u << 21;

constexpr uint32_t VM_ENTRY_IA32E_MODE_GUEST         = 1u << 9;
constexpr uint32_t VM_ENTRY_LOAD_IA32_PAT            = 1u << 14;
constexpr uint32_t VM_ENTRY_LOAD_IA32_EFER           = 1u << 15;

constexpr uint32_t VM_ENTRY_IA32E_MODE = 1u << 9;
